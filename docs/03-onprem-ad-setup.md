...
## What I built
Deployed a Windows Server 2022 VM (Standard_B1s) in `rg-identity` to 
...
## Cost management
- Used the smallest viable VM size (B1s) for a lab DC
- Enabled auto-shutdown at 19:00 daily to avoid idle running costs
- Standard SSD instead of Premium SSD for the OS disk

⚠️ This VM will be deleted at the end of the lab (Day 12) to avoid 
ongoing storage costs.

![Domain Controller Setup](../diagrams/addc-setup.png)# Day 3: On-Premises AD DS VM Setup
